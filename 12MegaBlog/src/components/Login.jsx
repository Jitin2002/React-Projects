...
function Login (){
    ...
    const login = async (data) => {
        setError('') // error ko clean krr do-- empty krr do error
        try {
            ...
            if(session){
                ...
                navigate('/') // root pe navigate krr do 
            }
    ...
    return(
        <div className="flex items-center justify-center w-full">
            <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border-black/10`}>
                ...
                { //error display kra na ha 
                }
                {error && <p className="text-red-600 mt-8 text-center">{error}</p>}
                {
                    // handlesubmit  ek method ha jha prr me apna method dunga
                }
                ...
                className="mt-8">
                    <div className="space-y-5">
                        ...
                        })} //javascript --  har bar spread krna pde ga compulsory ha  , name bhi dena  -- unique name dena ha
